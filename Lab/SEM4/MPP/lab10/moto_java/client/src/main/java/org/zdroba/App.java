...
public class App extends Application {
    ...
    private Stage createWindow(String title, SocketNotifier notifier) throws Exception {
        ...
        UserRepository authRepo = new UserRepositoryJPA();
        RaceEventRepository raceEventRepo = new RaceEventRepositoryJPA();
        RacerRepository racerRepo = new RacerRepositoryJPA();
