...
public class GenericRepo<T, ID> {
    ...
    protected final JpaUtil jpaUtil;
    ...
    public Optional<T> findById(ID id) {
        ...
        try (EntityManager em = jpaUtil.em()) {
            ...
            log.warn("[{}] findById FAILED: {}", entityClass.getSimpleName(), e.getMessage());
            e.printStackTrace();
            throw e;
        }
    }
    ...
    public List<T> findAll() {
        ...
        try (EntityManager em = jpaUtil.em()) {
            ...
            log.warn("[{}] findAll FAILED: {}", entityClass.getSimpleName(), e.getMessage());
            e.printStackTrace();
            throw e;
        }
    }
    ...
    public List<T> findBy(String fieldName, Object value) {
        ...
        try (EntityManager em = jpaUtil.em()) {
            ...
            log.warn("[{}] findBy FAILED: {}", entityClass.getSimpleName(), e.getMessage());
            e.printStackTrace();
            throw e;
        }
    }
    ...
    public long count() {
        ...
        try (EntityManager em = jpaUtil.em()) {
            ...
            log.warn("[{}] count FAILED: {}", entityClass.getSimpleName(), e.getMessage());
            e.printStackTrace();
            throw e;
        }
    }
