        ...
        try (Connection connA = DBConnection.getConnection();
            ...
            Thread tB = new Thread(() -> {
                try {
                    ...
                    PreparedStatement ps = connB.prepareStatement("UPDATE employees SET salary = 6000 WHERE id = 6");
                    ps.executeUpdate();
                    ...
                    PreparedStatement ps2 = connB.prepareStatement("UPDATE employees SET salary = 7000 WHERE id = 5");
                    ps2.executeUpdate();
