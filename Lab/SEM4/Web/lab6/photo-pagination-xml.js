(function () {
    ...
    function fetchPage(newOffset) {
        ...
        xhr.onload = function () {
            ...
            // xhr.responseXML is already a parsed XML document
            const xml    = xhr.responseXML;
            total        = parseInt(getText(xml, 'total'));
            offset       = parseInt(getText(xml, 'offset'));
    ...
    // Helper: get text content of a top-level tag
    function getText(xml, tag) {
        return xml.getElementsByTagName(tag)[0].textContent;
    }

    // Helper: get text of a tag inside a single <photo> element
