...
<!-- <script src="photo-pagination-jquery.js"></script> -->
<!-- <a href="photo-pagination.php">My Photos</a> -->
<!-- <a href="edit_photo.php">Edit Photos</a> -->
 <!-- <a href="edit_photo_jquery.php">Edit Photos (jQuery)</a> -->
</body>
</html>