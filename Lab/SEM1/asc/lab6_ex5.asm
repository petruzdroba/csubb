...
segment data use32 class=data
	...
	len equ ($-sir)/8   ;lungimea sirului (in quadwords) $-sir ne da numarul de octeti - de ai trb impartit la 8
...
segment code use32 class=code
    start:
        ...
        mov esi, sir
        cld     ;parcurgem sirul de la stanga la dreapta (DF=0) - incrementare

        mov ebx, 0;in registrul ebx vom retine numarul multiplilor lui 8 - index
